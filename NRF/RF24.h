...
typedef struct port_s{
	rf24_gpio_pin_t PIN_0;
	rf24_gpio_pin_t PIN_1;
	rf24_gpio_pin_t PIN_2;
	rf24_gpio_pin_t PIN_3;
	rf24_gpio_pin_t PIN_4;
	rf24_gpio_pin_t PIN_5;
	rf24_gpio_pin_t PIN_6;
	rf24_gpio_pin_t PIN_7;
}rf24_gpio_port_t;
EXTERN const struct rf24_gpio_cepin_s{
	rf24_gpio_port_t PORT_B;
	rf24_gpio_port_t PORT_D;
} CE_PIN ={{	{&PORTB,&DDRB,0},\
			{&PORTB,&DDRB,1},\
			{&PORTB,&DDRB,2},\
			{&PORTB,&DDRB,3},\
...
EXTERN const struct rf24_gpio_csnpin_s{
	rf24_gpio_port_t PORT_B;
	rf24_gpio_port_t PORT_D;
} CSN_PIN ={{	{&PORTB,&DDRB,0},\
			{&PORTB,&DDRB,1},\
			{&PORTB,&DDRB,2},\
			{&PORTB,&DDRB,3},\
			{&PORTB,&DDRB,4},\
